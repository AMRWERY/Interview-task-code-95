<template>
  <div>
    <header
      class="flex py-4 px-4 sm:px-6 bg-white min-h-[75px] tracking-wide relative z-50">
      <div class="flex flex-wrap items-center gap-5 w-full max-w-screen-xl mx-auto">
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <nuxt-link to="" class="hover:text-blue-700 text-blue-700 font-medium block text-[15px] uppercase">Products</nuxt-link>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <nuxt-link to=""
                class="hover:text-blue-700 text-slate-900 font-medium block text-[15px] uppercase">Services</nuxt-link>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <nuxt-link to=""
                class="hover:text-blue-700 text-slate-900 font-medium block text-[15px] uppercase">Training</nuxt-link>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <nuxt-link to=""
                class="hover:text-blue-700 text-slate-900 font-medium block text-[15px] uppercase">About Us</nuxt-link>
            </li>
          </ul>
        </div>
        ...
        <div class="flex items-center max-lg:ml-auto space-x-4">
          <button
            class="px-4 py-2 text-[15px] rounded-sm font-medium text-white bg-blue-600 hover:bg-blue-700 cursor-pointer">Sign
            up</button>
